...
function inv_rem(iy)
		...
		if not fget(mget(x,iy-i),3) and not fget(mget(x,iy-i),1) then mset(x,iy-i,0) end
end
...
function update()
		...
		if btnp(4) and can_travel() then
				...
				if gates[posstr(x,y-i)] and gates[posstr(x,y-i)].count==0 then 
						...
						tgt_room=rooms[2]
						gatetx=14; gatety=1
						if box_in_room(rooms[5]) and not inv_has(61) then rooms[4].tx=240 end
...
function can_travel()
		...
		while i<=inv_len() do 
				...
				offy=offy+1
				if fget(mget(gx,gy-i+offy),1) or gy-i+offy>=tgt_room.my+tgt_room.mh then return false end
				end
				i=i+1
		end
		return true
...
function can_climb(dx,dy)
		if dy==-1 then
				if fget(mget(x,y-inv_len()-1),1) then return false end
...
-- 128:
-- 130:
-- 131:
-- 132:
-- 133:
-- 134:
-- 135:
-- </MAP>
...
-- <FLAGS>
-- 000:
-- </FLAGS>
